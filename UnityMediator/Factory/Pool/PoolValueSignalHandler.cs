...
namespace Pryanik.UnityMediator.Factory.Pool
{
    ...
    #region Description
    /// <summary>
    /// Provides pool functionality with [Mediator] field assignment;
    /// </summary>
    /// <typeparam name="T">Instantiated type.</typeparam>
    #endregion
        ...
        ISignalHandler<PoolReturnSignal<T>>
    {
        ...
        internal PoolValueSignalHandler(SceneMediatorContext context, Func<PoolValueSignal<T>, T> createFunc)
        {
            _context = context;
